...
Ranger.prototype.paint = function(wrapper) {
  ...
  this.dataAttrValue = Ranger.utils.hashRange(this.toJSON());
  ...
  return this._textNodes.map(function(node) {
    ...
    wrapper.setAttribute(Ranger.DATA_ATTR, this.dataAttrValue);
...
Ranger.prototype.unpaint = function() {
  ...
  var dataAttrValue = this.dataAttrValue || Ranger.utils.hashRange(this.toJSON());
  
  var nodes = this._textNodes[0].ownerDocument.querySelectorAll('[' + Ranger.DATA_ATTR + '="' + dataAttrValue + '"]');
