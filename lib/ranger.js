...
Ranger.prototype.paint = function(wrapper) {
  ...
  this.id = Ranger.utils.hashRange(this.toJSON());
...
Ranger.prototype.unpaint = function() {
  ...
  var id = this.id || Ranger.utils.hashRange(this.toJSON()),
    nodes = this._textNodes[0].ownerDocument.querySelectorAll('[' + Ranger.DATA_ATTR + '="' + id + '"]');
